    ...
    <div className="p-4 sm:p-6 flex-1 flex flex-col h-full">
      ...
      <div className="flex-grow flex flex-col items-center justify-center text-center">
        ...
        <p className="text-muted-foreground mt-2 max-w-md">
          Ask me anything about your analytics, and I'll find the answer for you.
        </p>
      </div>
      ...
      <div className="mt-auto pt-4 max-w-3xl w-full mx-auto">
        <div className="relative">
          <Input
            placeholder="Pregunta por estadísticas de tu negocio, como '¿cuál fue la tasa de conversión en mayo?'"
